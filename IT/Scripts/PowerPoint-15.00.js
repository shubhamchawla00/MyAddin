...
Microsoft.Office.WebExtension.DocumentTheme={
	Dark1:"primaryTextColor",
	Light1: "primaryBackgroundColor",
	Dark2: "secondaryTextColor",
	Light2: "secondaryBackgroundColor",
	Accent1: "accent1",
	Accent2: "accent2",
	Accent3: "accent3",
	Accent4: "accent4",
	...
	if (officeCss){
			...
			var changeDocumentThemeData=function ChangeDocumentThemeData(data) {
				var documentThemeCssMapping=[
					{ name: "primaryTextColor", cssSelector: ".office-docTheme-primary-fontColor", cssProperty: "color" },
					{ name: "primaryBackgroundColor", cssSelector: ".office-docTheme-primary-bgColor", cssProperty: "background-color" },
					{ name: "secondaryTextColor", cssSelector: ".office-docTheme-secondary-fontColor", cssProperty: "color" },
					...
					{ name: "headerLocaleFont", cssSelector: ".office-headerFont-localized", cssProperty: "font-family" },
					...
					{ name: "bodyLocaleFont", cssSelector: ".office-bodyFont-localized", cssProperty: "font-family" },
					{ name: "backgroundColor", cssSelector: ".office-body-bgColor", cssProperty: "background-color" }
				];
			...
			var processDocumentThemeData=function ProcessDocumentThemeData(data){
					...
					getAndprocessThemeData(appContext.doc.getOfficeThemeAsync, processOfficeThemeData);
			};
