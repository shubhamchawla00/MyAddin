...
OSF.DDA.PowerPointDocumentInternal = function OSF_DDA_PowerPointDocumentInternal() {
    ...
    OSF.DDA.DispIdHost.addEventSupport(this, new OSF.EventDispatch([
		Microsoft.Office.Internal.EventType.OfficeThemeChanged,
		Microsoft.Office.Internal.EventType.DocumentThemeChanged
    ]));
    OSF.OUtil.finalizeProperties(this);
};
...
OSF.InitializationHelper.prototype.prepareRightBeforeWebExtensionInitialize = function OSF_InitializationHelper$prepareRightBeforeWebExtensionInitialize(appContext) {
    ...
    if (officeCss) {
        ...
        var processOfficeThemeData = function ProcessOfficeThemeData(data) {
            ...
            internal.addHandlerAsync(Microsoft.Office.Internal.EventType.OfficeThemeChanged, changeOfficeThemeData, null);
        }
        var processDocumentThemeData = function ProcessDocumentThemeData(data) {
            changeDocumentThemeData(data)
            internal.addHandlerAsync(Microsoft.Office.Internal.EventType.DocumentThemeChanged, changeDocumentThemeData, null);
        };
        getAndprocessThemeData(internal.getDocumentThemeAsync, processDocumentThemeData);
        Microsoft.Office.WebExtension.initialize(reason);
    }
    else {
        Microsoft.Office.WebExtension.initialize(reason);
