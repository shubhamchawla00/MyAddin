...
OSF.DDA.WAC.Delegate.registerEventAsync = function OSF_DDA_WAC_Delegate$RegisterEventAsync(args) {
    ...
    }, function OSF_DDA_WACOMFacade$OnRegisterEvent(xdmStatus, succeeded) {
        if(args.onReceiving) {
            args.onReceiving();
        }
        var status;
...
OSF.DDA.AsyncMethodCalls.define({
    ...
    onSucceeded: function (bindingDescriptor) {
        OSF.DDA.OMFactory.manufactureBinding(bindingDescriptor, Microsoft.Office.WebExtension.context.document);
    }
});
OSF.DDA.WAC.Delegate.ParameterMap.define({
