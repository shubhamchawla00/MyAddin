            ...
            else if (dispid)
            {
                ...
                window.external.Execute(dispid, executeParameters, function(nativeData, resultCode)
                {
                    if (responseCallback)
                    {
                        ...
                        {
                            deserializedData[OSF.DDA.AsyncResultEnum.ErrorProperties.Code] = responseData[1]
                        }
...
$h.AppointmentCompose.prototype = {
    _requiredAttendees$p$2: null, _optionalAttendees$p$2: null, _start$p$2: null, _end$p$2: null, _location$p$2: null, getItemType: function $h_AppointmentCompose$getItemType()
        ...
        }, _getRequiredAttendees$p$2: function $h_AppointmentCompose$_getRequiredAttendees$p$2()
        {
            ...
            {
                this._requiredAttendees$p$2 = new $h.ComposeRecipient(0)
            }
        ...
        }, _getOptionalAttendees$p$2: function $h_AppointmentCompose$_getOptionalAttendees$p$2()
        {
            ...
            {
                this._optionalAttendees$p$2 = new $h.ComposeRecipient(1)
            }
...
$h.ComposeBody._createParameterDictionaryToHost$p = function $h_ComposeBody$_createParameterDictionaryToHost$p(data, parameters)
{
    ...
    if (parameters._options$p$0 && parameters._options$p$0['coercionType'])
    {
        ...
        var $$t_5,
            $$t_6;
        if (!(($$t_6 = $h.ComposeBody._tryMapToHostCoercionType$p(parameters._options$p$0['coercionType'], ($$t_5 = {val: hostCoercionType}))), hostCoercionType = $$t_5.val, $$t_6))
        {
            if (parameters.get_callback())
            {
                var errorMessage = $h.OutlookErrorManager.getErrorArgs(1000)['message'];
                parameters.get_callback()(OSF.DDA.OutlookAppOm._instance$p.createAsyncResult(null, 1, errorMessage, parameters._asyncContext$p$0))
            }
            return null
        }
...
$h.ComposeRecipient = function $h_ComposeRecipient(type)
{
    this._type$p$0 = type
};
...
$h.ComposeRecipient.prototype = {
    _type$p$0: 0, getAsync: function $h_ComposeRecipient$getAsync()
        {
            var args = [];
            for (var $$pai_2 = 0; $$pai_2 < arguments.length; ++$$pai_2)
            {
            ...
            if (Array.isInstanceOfType(recipients))
            {
                for (var i = 0; i < recipients.length; i++)
                {
                    ...
                    else if (Object.isInstanceOfType(recipients[i]))
                    {
                        ...
                        recipientData[i] = $h.ComposeRecipient._createEmailDictionaryForHost$p(input['emailAddress'], input['displayName'])
                    }
                    else
                    {
...
$h.EmailAddressDetails.prototype = {
    _data$p$0: null, _getEmailAddress$p$0: function $h_EmailAddressDetails$_getEmailAddress$p$0()
        {
...
$h.MessageCompose.prototype = {
    _to$p$2: null, _cc$p$2: null, _bcc$p$2: null, getItemType: function $h_MessageCompose$getItemType()
        ...
        }, _getTo$p$2: function $h_MessageCompose$_getTo$p$2()
        {
            if (!this._to$p$2)
            {
                this._to$p$2 = new $h.ComposeRecipient(0)
            }
            return this._to$p$2
        }, _getCc$p$2: function $h_MessageCompose$_getCc$p$2()
        {
            if (!this._cc$p$2)
            {
                this._cc$p$2 = new $h.ComposeRecipient(1)
            }
            return this._cc$p$2
        }, _getBcc$p$2: function $h_MessageCompose$_getBcc$p$2()
        {
            if (!this._bcc$p$2)
            {
                this._bcc$p$2 = new $h.ComposeRecipient(2)
            }
...
{
    $h.OutlookErrorManager._addErrorMessage$p(9000, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_AttachmentExceededSize_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9001, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_ExceededMaxNumberOfAttachments_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9002, _u.ExtensibilityStrings.l_DataWriteErrorName_Text, _u.ExtensibilityStrings.l_InternalFormatError_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9003, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_InvalidAttachmentId_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9004, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_InvalidAttachmentPath_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9005, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_CannotAddAttachmentBeforeUpgrade_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9006, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_AttachmentDeletedBeforeUploadCompletes_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9007, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_AttachmentUploadGeneralFailure_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9008, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_AttachmentUploadGeneralFailure_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9009, _u.ExtensibilityStrings.l_AttachmentErrorName_Text, _u.ExtensibilityStrings.l_AttachmentDeleteGeneralFailure_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9010, _u.ExtensibilityStrings.l_DataWriteErrorName_Text, _u.ExtensibilityStrings.l_InvalidEndTime_Text);
    $h.OutlookErrorManager._addErrorMessage$p(9011, _u.ExtensibilityStrings.l_DataWriteErrorName_Text, _u.ExtensibilityStrings.l_HtmlSanitizationFailure_Text);
...
$h.InitialData.prototype = {
    _toRecipients$p$0: null, _ccRecipients$p$0: null, _attachments$p$0: null, _resources$p$0: null, _entities$p$0: null, _data$p$0: null, get__permissionLevel$i$0: function $h_InitialData$get__permissionLevel$i$0()
        {
