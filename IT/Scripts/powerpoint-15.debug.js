...
Microsoft.Office.WebExtension.OfficeTheme={
	PrimaryTextColor: "primaryTextColor",
	PrimaryBGColor: "primaryBGColor",
	SecondaryTextColor: "secondaryTextColor",
	SecondaryBGColor: "secondaryBGColor"
};
Microsoft.Office.WebExtension.DocumentTheme={
	Dark1:"dark1",
	Light1: "light1",
	Dark2: "dark2",
	Light2: "light2",
...
OSF.DDA.SafeArray.Delegate.SpecialProcessor=function OSF_DDA_SafeArray_Delegate_SpecialProcessor() {
	...
	var complexTypes=[
		...
		Microsoft.Office.WebExtension.Parameters.OfficeTheme,
		Microsoft.Office.WebExtension.Parameters.DocumentTheme
	];
	var dynamicTypes={};
...
OSF.DDA.SafeArray.Delegate.ParameterMap=(function () {
	...
	define({
		...
		fromHost: [
			{ name: Microsoft.Office.WebExtension.Parameters.DocumentTheme, value: self}
		]
	})
	define({
		type: OSF.DDA.EventDescriptors.OfficeThemeChangedEvent,
		fromHost: [
			{ name: Microsoft.Office.WebExtension.Parameters.OfficeTheme, value: self}
		]
	})
	define({
	...
	ns=Microsoft.Office.WebExtension.OfficeTheme;
	if (ns) {
		define({
			type:Microsoft.Office.WebExtension.Parameters.OfficeTheme,
			fromHost: [
						{name: ns.PrimaryTextColor, value: 0},
						{name: ns.PrimaryBGColor, value: 1},
						{name: ns.SecondaryTextColor, value:2},
						{name: ns.SecondaryBGColor, value:3}
			]
		})
	}
	...
	ns=Microsoft.Office.WebExtension.DocumentTheme;
	if (ns) {
		define({
			type:Microsoft.Office.WebExtension.Parameters.DocumentTheme,
			fromHost: [
						{name: ns.Dark1, value: 0},
						{name: ns.Light1, value: 1},
						{name: ns.Dark2, value: 2},
						{name: ns.Light2, value: 3},
						...
						{name: ns.BodyLatinFont, value: 15},
						{name: ns.BodyEastAsianFont, value: 16},
						{name: ns.BodyScriptFont, value: 17},
						{name: ns.BackgroundColor, value: 18},
			]
		})
	}
	...
	if (officeCss){
				...
				for (var i=0; i < length; i++) {
					...
					if ( ruleSelector !=="" && (ruleSelector.toLowerCase()==selector.toLowerCase()) ) {
						if (officeCss.cssRules) {
							...
							officeCss.insertRule(ruleSelector+newRule, 0);
						}
						else {
							officeCss.removeRule(i);
							officeCss.addRule(ruleSelector, newRule, 0);
						}
					}
				}
			}
			...
			var changeDocumentThemeData=function ChangeDocumentThemeData(data) {
				var documentThemeCssMapping=[
					{ name: "dark1", cssSelector: ".ms-dark1-color", cssProperty: "color" },
					{ name: "light1", cssSelector: ".ms-light1-color", cssProperty: "color" },
					{ name: "dark2", cssSelector: ".ms-dark2-color", cssProperty: "color" },
					{ name: "light2", cssSelector: ".ms-light2-color", cssProperty: "color" },
					{ name: "dark1", cssSelector: ".ms-dark1-bgColor", cssProperty: "background-color" },
					{ name: "light1", cssSelector: ".ms-light1-bgColor", cssProperty: "background-color" },
					{ name: "dark2", cssSelector: ".ms-dark2-bgColor", cssProperty: "background-color" },
					{ name: "light2", cssSelector: ".ms-light2-bgColor", cssProperty: "background-color" },
					{ name: "accent1", cssSelector: ".ms-contentAccent1-color", cssProperty: "color" },
					{ name: "accent2", cssSelector: ".ms-contentAccent2-color", cssProperty: "color" },
					{ name: "accent3", cssSelector: ".ms-contentAccent3-color", cssProperty: "color" },
					{ name: "accent4", cssSelector: ".ms-contentAccent4-color", cssProperty: "color" },
					{ name: "accent5", cssSelector: ".ms-contentAccent5-color", cssProperty: "color" },
					{ name: "accent6", cssSelector: ".ms-contentAccent6-color", cssProperty: "color" },
					{ name: "accent1", cssSelector: ".ms-contentAccent1-bgColor", cssProperty: "background-color" },
					{ name: "accent2", cssSelector: ".ms-contentAccent2-bgColor", cssProperty: "background-color" },
					{ name: "accent3", cssSelector: ".ms-contentAccent3-bgColor", cssProperty: "background-color" },
					{ name: "accent4", cssSelector: ".ms-contentAccent4-bgColor", cssProperty: "background-color" },
					{ name: "accent5", cssSelector: ".ms-contentAccent5-bgColor", cssProperty: "background-color" },
					{ name: "accent6", cssSelector: ".ms-contentAccent6-bgColor", cssProperty: "background-color" },
					{ name: "accent1", cssSelector: ".ms-contentAccent1-borderColor", cssProperty: "border-color" },
					{ name: "accent2", cssSelector: ".ms-contentAccent2-borderColor", cssProperty: "border-color" },
					{ name: "accent3", cssSelector: ".ms-contentAccent3-borderColor", cssProperty: "border-color" },
					{ name: "accent4", cssSelector: ".ms-contentAccent4-borderColor", cssProperty: "border-color" },
					{ name: "accent5", cssSelector: ".ms-contentAccent5-borderColor", cssProperty: "border-color" },
					{ name: "accent6", cssSelector: ".ms-contentAccent6-borderColor", cssProperty: "border-color" },
					{ name: "hyperlink", cssSelector: ".ms-a", cssProperty: "color" },
					{ name: "followedHyperlink", cssSelector: ".ms-a:visited", cssProperty: "color" },
					{ name: "headerLatinFont", cssSelector: ".ms-headerFont-latin", cssProperty: "font-family" },
					{ name: "headerEastAsianFont", cssSelector: ".ms-headerFont-eastAsian", cssProperty: "font-family" },
					{ name: "headerScriptFont", cssSelector: ".ms-headerFont-script", cssProperty: "font-family" },
					{ name: "bodyLatinFont", cssSelector: ".ms-bodyFont-latin", cssProperty: "font-family" },
					{ name: "bodyEastAsianFont", cssSelector: ".ms-bodyFont-eastAsian", cssProperty: "font-family" },
					{ name: "bodyScriptFont", cssSelector: ".ms-bodyFont-script", cssProperty: "font-family" },
					{ name: "backgroundColor", cssSelector: ".ms-body-bgColor", cssProperty: "background-color" }
				];
				...
				for (var i=0; i< documentThemeCssMapping.length; i++)
				{
					if (previousDocumentThemeData===null || previousDocumentThemeData[documentThemeCssMapping[i].name] !=realData[documentThemeCssMapping[i].name])
					{
						...
						{
							changeCss(officeCss, documentThemeCssMapping[i].cssSelector, "{"+documentThemeCssMapping[i].cssProperty+":"+realData[documentThemeCssMapping[i].name]+";}");
						}
						else
						{
			...
			var changeOfficeThemeData=function ChangeOfficeThemeData(data) {
				var officeThemeCssMapping=[
					{ name: "primaryTextColor", cssSelector: ".ms-officeTheme-primary-fontColor", cssProperty: "color" },
					{ name: "primaryBGColor", cssSelector: ".ms-officeTheme-primary-bgColor", cssProperty: "background-color" },
					{ name: "secondaryTextColor", cssSelector: ".ms-officeTheme-secondary-fontColor", cssProperty: "color" },
					{ name: "secondaryBGColor", cssSelector: ".ms-officeTheme-secondary-bgColor", cssProperty: "background-color" }
				];
			...
			var getAndprocessThemeData=function GetAndprocessThemeData(getThemeMethod, processResultCallback) {
			...
			var processOfficeThemeData=function ProcessOfficeThemeData(data) {
				...
				appContext.doc.addHandlerAsync(Office.EventType.OfficeThemeChanged, changeOfficeThemeData, null);
				Microsoft.Office.WebExtension.initialize(reason);
			}
			var processDocumentThemeData=function ProcessDocumentThemeData(data){
					changeDocumentThemeData(data)
					appContext.doc.addHandlerAsync(Office.EventType.DocumentThemeChanged, changeDocumentThemeData, null);
					Microsoft.Office.WebExtension.initialize(reason);
			};
			getAndprocessThemeData(appContext.doc.getDocumentThemeAsync, processDocumentThemeData);
	}
	else {
		Microsoft.Office.WebExtension.initialize(reason);
	}
